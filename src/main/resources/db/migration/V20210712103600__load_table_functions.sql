...
delimiter #
create procedure load_user_hybrid_data()
begin
    declare v_max int unsigned default 10000000;
    declare v_counter int unsigned default 1;
    ...
    while v_counter < v_max
        do
            insert into user_hybrid (id, external_id, name) values (v_counter, UUID_TO_BIN(uuid(), true), 'name');
            insert into address_hybrid (user_id, street, neighborhood, city, country, number)
            VALUES (v_counter, 'street', 'neighborhood', 'city', 'country', 50),
                   (v_counter, 'street', 'neighborhood', 'city', 'country', 50),
                   (v_counter, 'street', 'neighborhood', 'city', 'country', 50),
                   (v_counter, 'street', 'neighborhood', 'city', 'country', 50),
...
begin
    ...
    while v_counter < v_max
        do
            ...
            insert into address_uuid_varchar (id, user_id, street, neighborhood, city, country, number)
            VALUES (uuid(), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (uuid(), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (uuid(), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (uuid(), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (uuid(), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (uuid(), identity, 'street', 'neighborhood', 'city', 'country', 50),
...
begin
    ...
    while v_counter < v_max
        do
            ...
            insert into address_uuid_bin (id, user_id, street, neighborhood, city, country, number)
            VALUES (UUID_TO_BIN(uuid(), true), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (UUID_TO_BIN(uuid(), true), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (UUID_TO_BIN(uuid(), true), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (UUID_TO_BIN(uuid(), true), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (UUID_TO_BIN(uuid(), true), identity, 'street', 'neighborhood', 'city', 'country', 50),
                   (UUID_TO_BIN(uuid(), true), identity, 'street', 'neighborhood', 'city', 'country', 50),
